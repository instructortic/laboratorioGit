document.addEventListener('DOMContentLoaded', () => {
  ...
  */
  ...
  /**
   * Pricing toggle functionality (safe check)
   */
  const togglePricing = document.getElementById("toggle-pricing");
  if (togglePricing) {
    togglePricing.addEventListener("change", function () {
      document.querySelectorAll(".monthly, .monthly-text").forEach(el => el.classList.toggle("d-none"));
      document.querySelectorAll(".yearly, .yearly-text").forEach(el => el.classList.toggle("d-none"));
    });
  }

  /**
   * FAQ toggle functionality (safe check)
   */
